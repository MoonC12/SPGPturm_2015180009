...
public class Enemy implements GameObject, BoxCollidable, Recyclable {
    ...
    public static Enemy get(int level, int x, int y, int speed, int hit) {
        ...
        enemy.init(level, x, y, speed, hit);
        return enemy;
    }

    private void init(int level, int x, int y, int speed, int hit) {
        this.x = x;
        this.y = y;
        this.speed = speed;
        this.level = level;
